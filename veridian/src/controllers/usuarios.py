...
class Usuario:
    @classmethod
    def adicionar(cls, cpf: str, nome: str, rg: str, nascimento: int, genero: str, id_endereco: int, id_contato: int):
        query = '''
            INSERT INTO usuarios (cpf, nome, rg, nascimento, genero, id_endereco, id_contato)
            VALUES (?, ?, ?, ?, ?, ?, ?)
        '''
        dados = (cpf, nome, rg, nascimento, genero, id_endereco, id_contato)
